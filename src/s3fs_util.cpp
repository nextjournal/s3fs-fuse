	       ...
	       || strConType == "httpd/unix-directory"){ // Nextcloud uses this MIME type for directory objects when mounting bucket as external Storage
              ...
              if(strConType == "binary/octet-stream" || strConType == "application/octet-stream"){
                ...
                if(complement_stat){
                  ...
                  // and content type is text/plain or application/x-www-form-urlencoded it should be directory.
                  if(strConType == "text/plain" || strConType == "application/x-www-form-urlencoded"){
                    mode |= S_IFDIR;
                  }else{
                    mode |= S_IFREG;
                  }
